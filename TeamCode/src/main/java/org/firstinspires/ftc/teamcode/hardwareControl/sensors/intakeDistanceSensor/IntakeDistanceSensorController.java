package org.firstinspires.ftc.teamcode.hardwareControl.sensors.intakeDistanceSensor;
...
public class IntakeDistanceSensorController {
    ...
    private static final IntakeDistanceSensorController INSTANCE = new IntakeDistanceSensorController();
    ...
    private IntakeDistanceSensorController() {
        // Initialize hardware, state, or configuration here

    }

    // Public method to access the singleton instance
    public static IntakeDistanceSensorController getInstance() {
        return INSTANCE;
    }
